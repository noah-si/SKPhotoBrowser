...
open class SKPhoto: NSObject, SKPhotoProtocol {
    ...
    convenience init(url: String, holder: UIImage?, token: String? = "") {
        self.init()
        photoURL = url
    ...
    open func loadUnderlyingImageAndNotify() {
        ...
        request.allHTTPHeaderFields = ["userToken": accessToken ?? ""]
...
extension SKPhoto {
    ...
    public static func photoWithImageURL(_ url: String, token: String) -> SKPhoto {
        return SKPhoto(url: url, token: token)
    }
